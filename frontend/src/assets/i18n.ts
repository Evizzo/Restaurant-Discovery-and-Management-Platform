...
const resources = {
  ...
  sr: {
    translation: {
      ...
      "owners_description": "Sajt omogućava da predstavite svoj lokal na najbolji mogući način. Uz mogućnost postavljanja odvojenih slika za meni i ambijent, vlasnici mogu lako kreirati atraktivan profil svog lokala. Takođe, možete postaviti QR kod za direktan pristup vašem profilu, što olakšava korisnicima da vas pronađu i naruče. Platforma vam pruža sve potrebne alate da imate sopstvenu stranicu bez potrebe za izradom zasebnog sajta. Svaki sajt prvo čeka na odobrenje od strane admina.",
