...
const TOS = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-5 py-10 bg-gradient-to-r from-[#D1A373] to-[#8B5A2B]">
      <h1 className="font-semibold text-center text-4xl lg:mt-14 mt-24 mb-8">{t('tos_title')}</h1>
      <div className="flex flex-col lg:flex-row items-center gap-5">
        ...
        <div className="w-full lg:w-2/4 p-4 space-y-3">
          ...
          <p>
            <strong>{t('data_availability_title')} </strong>
            <br />
            {t('data_availability_description')}
          </p>
          <p>
            <strong>{t('liability_title')} </strong>
            <br />
            {t('liability_description')}
          </p>
          <p>
            <strong>{t('termination_title')} </strong>
            <br />
            {t('termination_description')}
          </p>
          <p>
            <strong>{t('changes_title')} </strong>
            <br />
